      ...
      <Modal isShow={isShow} onClose={state => setIsShow(state)}>
        <form ref={formRef} onSubmit={handleSubmit}>
          ...
          <div className="p-5 text-black">
            <InputGroupComponent id={`name`} type="text" value={user.name.toString()}
              onChange={val => setUser({ ...user, name: val })}
              required={true} label="Name" />

            <InputGroupComponent id={`email`} type="email" value={user.email.toString()}
            ...
            <InputGroupComponent id={`password`} type="text" value={user.password.toString()} // Change the type of value from String to string
