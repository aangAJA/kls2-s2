...
const CategoryBadge: React.FC<CategoryBadgeProps> = ({ category }) => {
  switch (category) {
    case "JET":
      return (
        <span className="bg-yellow-200 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">Jet</span>
      )
    case "TANK":
      return (
        <span className="bg-orange-200 text-orange-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">Tank</span>
      )
    default:
      return (
        <span className="bg-amber-300 text-amber-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">Ambalan</span>
      )
  }
}
