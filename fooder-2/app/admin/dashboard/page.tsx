...
import Profile from "../../../public/image/download (1).jpeg";
        ...
        <header className="bg-gray-500 shadow">
          <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-gray-900">
              ewqerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
            </h1>
          </div>
        </header>
        <main>
          <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div className="px-4 py-6 sm:px-0">
              <div className="rounded-lg bg-gray-500 p-6 shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                  ...
                  <div className="flex items-center p-4 bg-white rounded-lg shadow-xs">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-600">Pesan Barang</p>
                      <p className="text-lg font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                  <div className="flex items-center p-4 bg-white rounded-lg shadow-xs">
                ...
                <div className="mt-6">
                  ...
                  <div className="flex space-x-4 mt-4">
                    <Link href="/admin/menu" className="flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600">
                      <FaClipboardList className="mr-2" />
                      Menus
                    </Link>
                    {/* <Link href="/admin/menu_favorite" className="flex items-center px-4 py-2 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600">
                      <FaStar className="mr-2" />
                      menu favourite
                    </Link> */}
                    <Link href="/admin/pesan_barang" className="flex items-center px-4 py-2 bg-yellow-500 text-white rounded-lg shadow-md hover:bg-yellow-600">
                      <FaBellConcierge className="mr-2" />
                      pesan barang
                    </Link>
                    <Link href="/admin/history" className="flex items-center px-4 py-2 bg-red-500 text-white rounded-lg shadow-md hover:bg-red-600">
