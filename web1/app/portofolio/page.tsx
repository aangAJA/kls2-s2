    ...
    return (
        <main className="container mx-auto">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 h-screen">
                <h2 className="text-2xl font-bold tracking-tight text-center text-soft-brown">My Skill</h2>
                {/* Category Filter */}
                <div className="mt-4 mb-6 flex justify-center space-x-4">
                    ...
                    <Link href="/portofolio?category=coding" className={`text-soft-brown ${category === 'coding' ? 'font-bold' : ''}`}>coding</Link>
                    <Link href="/portofolio?category=olahraga" className={`text-soft-brown ${category === 'olahraga' ? 'font-bold' : ''}`}>olahraga</Link>
                </div>
